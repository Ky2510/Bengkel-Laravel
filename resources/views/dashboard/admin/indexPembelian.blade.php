                        ...
                        <div class="card-tools">
                            {!! Form::open(['route' => $routePrefix. '.index', 'method' => 'GET' ]) !!}
                                <div class="input-group input-group-sm">
                                    <input class="form-control form-control-navbar" name="search" value="{{ request('search') }}" type="search" placeholder="Cari nama barang..." aria-label="Search">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="font-family: 'Alice', serif; color:#272829;">Jenis Motor</th>
                                        <th style="font-family: 'Alice', serif; color:#272829;">Harga Beli</th>
                                        <th style="font-family: 'Alice', serif; color:#272829;">Harga Jual</th>
                                        <th style="font-family: 'Alice', serif; color:#272829;">Stok </th>
                                        <th style="font-family: 'Alice', serif; color:#272829;">Suplayer</th>
                                        <th style="font-family: 'Alice', serif; color:#272829;">Tanggal</th>
                                        <th style="font-family: 'Alice', serif; color:#272829; width: 10px">Manage</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ route($routePrefix . '.edit', $item->id) }}" class="btn btn-warning btn-md btn-sm d-inline-block mr-1"><i class="fa-solid fa-pen-to-square"></i></a>
