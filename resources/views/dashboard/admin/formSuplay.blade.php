                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        {!! Form::label('nama', 'Nama Suplayer') !!}
                                        {!! Form::text('nama', old('nama'), ['class' => 'form-control ' . ($errors->first('nama') ? 'is-invalid' : ''), 'placeholder' => "Masukan nama ..."]) !!}
                                        <span class="text-danger">{{ $errors->first('nama') }}</span>
                                    </div>
                                    <div class="form-group">
                                        {!! Form::label('no_hp', 'No. HP') !!}
                                        {!! Form::number('no_hp', old('no_hp'), ['class' => 'form-control ' . ($errors->first('no_hp') ? 'is-invalid' : ''), 'placeholder' => "Masukan No. HP ..."]) !!}
