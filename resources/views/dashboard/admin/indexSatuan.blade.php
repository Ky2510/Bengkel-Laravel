                        ...
                        <div class="card-tools">
                            {!! Form::open(['route' => $routePrefix. '.index', 'method' => 'GET' ]) !!}
                                <div class="input-group input-group-sm">
                                    <input class="form-control form-control-navbar" name="search" value="{{ request('search') }}" type="search" placeholder="Cari nama satuan..." aria-label="Search">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="font-family: 'Alice', serif; color:#272829;">Nama Satuan</th>
                                        <th style="font-family: 'Alice', serif; color:#272829;">ID Satuan</th>
