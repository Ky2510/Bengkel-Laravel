                        ...
                        <div class="card-tools">
                            {!! Form::open(['route' => $routePrefix. '.index', 'method' => 'GET' ]) !!}
                                <div class="input-group input-group-sm">
                                    <input class="form-control form-control-navbar" name="search" value="{{ request('search') }}" type="search" placeholder="Cari nama merek..." aria-label="Search">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="font-family: 'Alice', serif; color:#272829;">Nama Merek</th>
                                        <th style="font-family: 'Alice', serif; color:#272829;">Kode Merek</th>
